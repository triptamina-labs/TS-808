...
function KnobOverlay(props) {
  const { topPosition, scale, knobCenter, cursorPos, overlayColor = "#FFF" } = props;
  ...
  const styles = {
    ...
    topPath: {
      ...baseLineStyle,
      transform:
        `translateX(${cursorPos[0]}px) translateY(${topPosition}px) translateZ(0) ` + `scaleX(12)`
    },
