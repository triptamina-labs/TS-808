...
// LAYOUT MACROS ==========================
export const ring = (size: number | string, color?: string) => ({
...
const supportsSupports = typeof window !== "undefined" && window.CSS != null && window.CSS.supports != null;

const supportsFocusRingColor =
  supportsSupports && window.CSS.supports("outline-color", "-webkit-focus-ring-color");
...
export const focusOutline = {
  ...
  outlineColor: supportsFocusRingColor ? "-webkit-focus-ring-color" : "Highlight"
};
